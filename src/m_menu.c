...
static menuitem_t OP_VideoOptionsMenu[] =
{
	...
	{IT_HEADER, NULL, "Accessibility", NULL, 55},
    {IT_STRING | IT_CVAR, NULL, "Screenshake Effects", &cv_earthquake, 61},

	{IT_HEADER, NULL, "Heads-Up Display", NULL, 70},
	{IT_STRING | IT_CVAR, NULL, "Show HUD",                  &cv_showhud,          76},
	{IT_STRING | IT_CVAR | IT_CV_SLIDER,
	                      NULL, "HUD Transparency",          &cv_translucenthud,   81},
	{IT_STRING | IT_CVAR, NULL, "Score/Time/Rings",          &cv_timetic,          86},
	{IT_STRING | IT_CVAR, NULL, "Show Powerups",             &cv_powerupdisplay,   91},
	{IT_STRING | IT_CVAR, NULL, "Local ping display",		&cv_showping,			96}, // shows ping next to framerate if we want to.
	{IT_STRING | IT_CVAR, NULL, "Show player names",         &cv_seenames,         101},
	...
	{IT_STRING | IT_CVAR, NULL, "Show Movie Info",           &cv_moviemodeinfo,   231},

#ifdef HWRENDER
	{IT_HEADER, NULL, "Renderer", NULL, 239},
	{IT_CALL | IT_STRING, NULL, "OpenGL Options...",         M_OpenGLOptionsMenu, 245},
	{IT_STRING | IT_CVAR, NULL, "FPS Cap",                   &cv_fpscap,          250},
#endif
};
