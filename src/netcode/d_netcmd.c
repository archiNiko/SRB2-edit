...
{
#ifdef DEVELOP
	CONS_Printf("Sonic Robo Blast 2 Edit %s %s %s (%s %s) ", compbranch, comprevision, compnote, compdate, comptime);
#else
	CONS_Printf("Sonic Robo Blast 2 Edit %s (%s %s %s %s) ", VERSIONSTRING, compdate, comptime, comprevision, compbranch);
#endif
